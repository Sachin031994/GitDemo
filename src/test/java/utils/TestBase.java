	...
	public WebDriver WebDriverManager() throws IOException {
		...
		if (driver == null) {
			if (browser.equalsIgnoreCase("chrome")) {
				...
				// SetUp\\chrome-win64\\chrome.exe");//System.getProperty("user.dir")+//"//src//test//resources//chromedriver.exe");
				// ChromeOptions Options = new ChromeOptions();
				// ChromeOptions option= new ChromeOptions();
				// option.setBinary("C:\\Automation SetUp\\chrome-win64\\chrome.exe");
